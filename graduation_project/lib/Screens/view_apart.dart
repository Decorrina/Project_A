...
class _ViewApartState extends State<ViewApart> {
  ...
  Widget build(BuildContext context) {
    // Room data
    final rooms = [
      {'id': 1, 'beds': 2, 'price': '450L.E'},
      {'id': 2, 'beds': 3, 'price': '200L.E'},
    ];

    // Amenities data
    final amenities = [
      {'icon': 'assets/icons/wifi.svg', 'name': 'Wifi'},
      {'icon': 'assets/icons/kitchen.svg', 'name': 'Shared kitchen'},
      {'icon': 'assets/icons/ac.svg', 'name': 'Air conditioner'},
      {'icon': 'assets/icons/tv.svg', 'name': 'Tv'},
    ];
                      ...
                      child: Stack(
                        children: [
                          ...
                          Positioned(
                            ...
                            child: Icon(Icons.bed, weight: 80, color: Colors.white,size: 50,),
                          ),
                          Positioned(
                            top: 101,
                            left: 158,
